...
while True:
    if Played_before == "yes":
        ...
        print("So, everything you can do is, ChipCount, Check, Call, <Amount> you'd wish to raise, just put: 10000, Allin, Fold and RunHandThroughHair")
        print("Try to enjoy")
        break
    if Played_before == "no":
        BabySteps = True
        ...
        if following == "yes":
            ...
            print("So, everything you can do is, ChipCount, Check, Call, <Amount> you'd wish to raise, just put: 10000, Allin, Fold !Help and RunHandThroughHair")
            break
        if following == "no":
...
print("You take a deep breath in, exhale hard but silent, shuffle into your seat, notice the lights have diimed from the audience in shine off the table")
...
while playing = True:
    if hand1 == "fold":
        "As there is nothing to lose, and all to gain, this is pointless"
        break
    if hand1 == "Check" or hand1 == "Call":
        break
    if hand1 < 10000:
        print("Thats too low, lowest bet is 10000")
    if hand1 >= 10000 and hand1 < 100000:
        break
    if hand1 >= 100000 and hand1 < 200000:
        print("Agressive, but risky")
    if hand1 > 200000 and hand1 < Chipcount:
        print("You grab the chips needed, a large stack, but you hear your dad cough a lough 2 coughs, maybe play things a little steadier")
    if hand1 == "Allin":
        print("You grab all your chips, a large stack, but you hear your dad cough a lough 2 coughs, maybe play things a little steadier")
    if hand1 == "ChipCount":
        print(ChipCount)
    if hand1 == "!Help":
       print("You have:", ChipCount, "Chips, id reccomend just calling.")
    if hand1 == "RunHandThroughHair":
